package org.kafka.origin.consumergroup;
...
public class GroupBConsumer2 {
    ...
    public static void main(String[] args) {
        ...
        /*消费配置的实例*/
        Properties properties = KafkaConst.consumerConfig(BusiConst.CONSUMER_GROUP_B, StringDeserializer.class, StringDeserializer.class);
        /*消息消费者*/
