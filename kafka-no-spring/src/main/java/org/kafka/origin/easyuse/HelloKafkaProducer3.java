 ...
 */
public class HelloKafkaProducer3 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            //key用于kafka分区器判断将消息放到哪个分区，如果key为null，kafka会通过算法均匀的key为null的消息分布在分区上。
            ...
            producer.send(record, new Callback() {//异步接收确认消息，不能确定什么时候能够接收到确认信息，异步方式也是常用的方式
                @Override
